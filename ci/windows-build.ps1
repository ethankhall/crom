...
invoke-restmethod -usebasicparsing 'https://github.com/ethankhall/crom/releases/download/v0.1.2/crom-windows.exe' -outfile 'crom.exe'
./crom.exe update-version --pre-release release
